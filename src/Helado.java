 ...
 * @author itoan
 */
class Helado extends GLJPanel implements GLEventListener, KeyListener {

    private static String TITLE = "HELADO";  // window's title
    ...
    public void init(GLAutoDrawable drawable) {
        ...
        gl.glClearColor(0.7f, 0.5f, 0.8f, 1.0f); // set background (clear) color
    ...
    public void setSomeBrownMaterial(GL2 gl, int face){
        float [] colorBrown={0.6f, 0.4f, 0.2f, 1.0f};
    ...
    gl.glPushMatrix();
    {
        ...
        gl.glTranslatef(lightX, lightY, lightZ);  // Ajusta las dimensiones de la esfera que ilumina
    ...
    public void drawHelado(GL2 gl, GLUT glut) {
    // Dibuja el cono
    //gl.glRotatef(180, 1.0f, 0.0f, 0.0f);
    setSomeBrownMaterial(gl, GL.GL_FRONT);
    gl.glPushMatrix();
    {
        gl.glTranslatef(0.0f, -1.0f, 0.0f);
        gl.glRotatef(90, 1.0f, 0.0f, 0.0f);  // Orientación del cono
        glut.glutSolidCone(1.0f, 3.0f, 20, 20); //Ajusta las dimensiones del cono
        //Dibuja la bola de helado
        gl.glTranslatef(0.0f, 0.0f, -0.5f); //Ajusta la posición de la bola de helado
        setSomeWhiteMaterial(gl, GL.GL_FRONT);
        glut.glutSolidSphere(1.2f, 20, 20);
    }
        gl.glPopMatrix();
    }
